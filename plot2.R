plot2 <- function(){
        ...
        ## B) Objetive
        ## To produce a line plot of the active power of a set of dates and save it to a png file
        ...
        if(file.exists(fileName)){
                ...
                with(febData, plot(Time, Global_active_power, type="l", main="Global Active Power", ylab = "Global Active Power (kilowatts)", xlab=""))
                dev.off()
